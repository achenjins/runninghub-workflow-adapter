...
> ⚠️ **适用范围**：本插件目前**仅适配 NapCat 的 QQ**，其余平台 / 适配器未经测试，可能无法正常使用。
...
1. [这个插件能做什么](#这个插件能做什么)
2. [安装](#安装)
3. [装好之后：三步跑通第一张图](#装好之后三步跑通第一张图)
4. [可选：开启提示词扩写](#可选开启提示词扩写)
5. [识别之后：整理你的输入节点](#识别之后整理你的输入节点)
6. [常用命令速查表](#常用命令速查表)
7. [小白必懂的几个概念](#小白必懂的几个概念)
8. [完整配置项参考](#完整配置项参考)
9. [进阶玩法](#进阶玩法)
...
| 命令 | 作用 | 例子 |
|------|------|------|
| **/跑图 工作流名 描述** | 运行工作流生成图片 / 视频 | /跑图 文生图 原神刻晴 |
| **/工作流** | 列出已配置的工作流 | /工作流 |
