...
开启后，你只要写「一只猫」，插件会先用 AI 按模板扩写成一段详细的提示词再提交。

1. 在插件目录下新建一个模板文件，比如 templates/my_template.txt，内容写你的扩写要求（例如「请把用户需求扩写成英文 SD 提示词，包含画质、构图、光影、风格词」）。
2. 在工作流配置里：llm_enhance 打开，llm_template_path 填 templates/my_template.txt。
