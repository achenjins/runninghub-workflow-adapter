...
> [!NOTE]
> 这个工作流魔改自 B 站视频教程 [BV1arGt6wExL](https://www.bilibili.com/video/BV1arGt6wExL)，感谢 up 主 [@每日提钢小助手5号](https://space.bilibili.com/3690999272442168) 分享的工作流，如侵权可联系删除。将up工作流保存后工作流id（链接中数字）会改变为你账号专属，用命令时记得对应更换id。该up工作流自带提示词优化，会消耗rh上的余额
...
1. 在插件目录下新建一个模板文件，比如 templates/my_template.txt，内容写清楚「要 AI 怎么扩写」，你可以查找对应模型的提示词模板，文档或skill，让ai给你总结一份提示词，越详细写的越好，扩写模型建议用deepseekV4flash，支持txt/md文件。示例：
